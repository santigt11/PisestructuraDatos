...
//    }
    ...
    private void initComponents() {
        ...
        jpMatricula.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, -1, 20));

        jLabel9.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("DNI:");
        jLabel9.setToolTipText("");
        jpMatricula.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, -1, -1));
        ...
        jpMatricula.add(txtDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 155, -1));
        ...
        jpMatricula.add(txtApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 152, -1));
        ...
        jpMatricula.add(txtNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 152, -1));

        jLabel10.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel10.setText("Telefono:");
        jLabel10.setToolTipText("");
        jpMatricula.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, -1, 20));
        ...
        jpMatricula.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 152, -1));

        jLabel12.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel12.setText("Fecha de Registro:");
        jLabel12.setToolTipText("");
        jpMatricula.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, -1, 26));

        dtRegistro.setFont(new java.awt.Font("Roboto Light", 0, 11)); // NOI18N
        dtRegistro.setPreferredSize(new java.awt.Dimension(93, 24));
        jpMatricula.add(dtRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 130, -1));
        ...
        jpMatricula.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, 20));
        ...
        jpMatricula.add(cbxExpediente, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, -1, -1));

        jLabel21.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel21.setText("Nro. Matricula:");
        jLabel21.setToolTipText("");
        jpMatricula.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, 20));
        ...
        jpMatricula.add(txtPeriodo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 146, -1));

        jLabel7.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Nombres:");
        jLabel7.setToolTipText("");
        jpMatricula.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, -1, 20));

        jLabel27.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel27.setText("Periodo Academico:");
        jLabel27.setToolTipText("");
        jpMatricula.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, -1, 20));

        spnNro.setFont(new java.awt.Font("Roboto", 1, 11)); // NOI18N
        spnNro.setEnabled(false);
        jpMatricula.add(spnNro, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 90, -1));

        jPanel4.add(jpMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 0, 390, 310));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 40, 100, -1));
    ...
    private void lstEstudianteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstEstudianteMouseClicked
        if (lstEstudiante.getSelectedValue() != null)
        try {
            cargarVista(1);
        } catch (EmptyException ex) {
            Logger.getLogger(FrmMatricula.class.getName()).log(Level.SEVERE, null, ex);
